...
#if !defined(INC_ROSECALLPATHHPCT_HH)
//! rosehpct.hh included.
#define INC_ROSECALLPATHHPCT_HH
...
namespace RoseCallPathHPCT
{
  ...
  const std::string m_cputime="CPUTIME (usec).[0,0]";
  const std::string m_perf_count_hw_cache="perf::PERF_COUNT_HW_CACHE_L1D.[0,0]";
  const std::string m_perf_cycles="perf::CYCLES.[0,0]";
  ...
  ROSE_DLL_API extern std::set<const RoseCallPathHPCT::IRNode *> profFileNodes_;
  ROSE_DLL_API extern std::set<const RoseCallPathHPCT::IRNode *> profStmtNodes_;
  ...
  ROSE_DLL_API extern std::map<const RoseCallPathHPCT::IRNode *, std::set<SgLocatedNode *> > profSageMap_;
