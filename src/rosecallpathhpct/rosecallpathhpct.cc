...
void commandLineProcessing(std::vector<std::string> &argvList)
{
  ...
  {
    cout<<"Enabling debugging mode for RoseCallPathHPCT..."<<endl;
    enable_debug= true;
  }
  else
    enable_debug= false;
  ...
  {
    cout<<"RoseCallPathHPCT-specific options"<<endl;
 ...
 *
 *  \see RoseCallPathHPCT::getEquivPaths, RoseCallPathHPCT::loadProfilingFiles
 */
FilenameList_t
RoseCallPathHPCT::getProfileOptions (vector<string>& argvList)
{
 ...
 *
 *  \see RoseCallPathHPCT::getProfileOptions, RoseCallPathHPCT::loadProfilingFiles
 */
EquivPathMap_t
RoseCallPathHPCT::getEquivPaths (vector<string>& argvList)
{
 ...
 *  recognized, see \ref RoseCallPathHPCT::getProfileOptions and \ref
 *  RoseCallPathHPCT::getEquivPaths .
 *
 ...
 *  structure.
 */
RoseCallPathHPCT::ProgramTreeList_t
RoseCallPathHPCT::loadProfilingFiles (vector<string>& argvList)
{
...
void
RoseCallPathHPCT::attachMetricsRaw (const ProgramTreeList_t& profiles,
                            SgProject* proj,
                            bool verbose)
{
...
void
RoseCallPathHPCT::attachMetrics (const ProgramTreeList_t& profiles,
                         SgProject* proj,
                         bool verbose)
{
